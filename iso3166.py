...
_records = [
    ...
    Country(u"Republic of Congo", "CG", "COG", "178", u"Republic of Congo"),
    Country(u"Democratic Republic of Congo", "CD", "COD", "180", u"Democratic Republic of Congo"),
    ...
    Country(u"Iran", "IR", "IRN", "364", u"Iran"),
    ...
    Country(u"Ivory Coast", "CI", "CIV", "384", u"Ivory Coast"),
    ...
    Country(u"Laos", "LA", "LAO", "418", u"Laos"),
    ...
    Country(u"Moldova", "MD", "MDA", "498", u"Moldova"),
    ...
    Country(u"Russia", "RU", "RUS", "643", u"Russia"),
